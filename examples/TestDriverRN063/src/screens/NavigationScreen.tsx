...
const NavigationScreen = ({ navigation }) => {
  return (
    <ScrollView>
      <Button title='Navigation - Tabs' onPress={() => navigation.push('TabNavigation')} />
      <Button title='Navigation - Stack' onPress={() => navigation.push('StackNavigation')} />
      <Button title='Navigation - Drawer' onPress={() => navigation.push('DrawerNavigation')} />
    </ScrollView>
  );
}
...
export const NavigationStackScreen = () => {
  return (
    <NavigationStack.Navigator>
      ...
      <NavigationStack.Screen name="TabNavigation" component={TabNavigationScreen} />
      <NavigationStack.Screen name="StackNavigation" component={StackNavigationScreen} />
